...
class ArticleHolder extends Page
{
    ...
    public function ArchiveDates()
    {
        ...
        $query
            ...
            ->setOrderBy("DATE_FORMAT(`Date`, '%Y_%M_%m')", 'ASC') // same as SELECT
            ->setDistinct(true);
...
class ArticleHolder_Controller extends Page_Controller
{
    ...
    public function Region(SS_HTTPRequest $req)
    {
    ...
    public function date(SS_HTTPRequest $req)
    {
        $year = $req->param('ID');
        $month = $req->param('otherID');
